...
def rerank_documents(query: str, documents: list, top_k: int = 5) -> tuple:
    ...
    Returns:
        ...
        - reranked_docs: List of Document objects yang sudah diurutkan
        - top_score: Skor tertinggi dari dokumen pertama (float).
          Digunakan untuk confidence threshold — jika rendah, query tidak relevan.
    """
    ...
    # (Opsional) Log hasil re-ranking untuk debugging
    ...
    # 5. Ambil hanya dokumennya sebanyak top_k + top score
