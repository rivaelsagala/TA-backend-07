...
if __name__ == "__main__":
    ...
    SINGLE_FILE = "PERATURAN_DESA_CIPEDES_NOMOR_04_TAHUN_2018_chunks.json"  # Ubah ke nama file untuk proses satu file saja
    ...
    # Setup Output
    OUTPUT_FILENAME = "raft_perdes_dataset_2.jsonl"
    ...
    if output_path.exists():
        ...
        backup_filename = f"raft_perdes_dataset_backup_2{timestamp}.jsonl"
