...
if __name__ == "__main__":
    ...
    SINGLE_FILE = "PERATURAN_DESA_CIGENTUR_KECAMATAN_PASEH_KABUPATEN_BANDUNG_NOMOR_8_TAHUN_2018_chunks.json"  # Ubah ke nama file untuk proses satu file saja
    ...
    # Setup Output
    OUTPUT_FILENAME = "raft_perdes_dataset_3.jsonl"
    ...
    if output_path.exists():
        ...
        backup_filename = f"raft_perdes_dataset_backup_3{timestamp}.jsonl"
